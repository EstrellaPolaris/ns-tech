  ...
  return (
    <section className="px-8 py-40">
      <div className="container mx-auto">
        <Card placeholder={undefined} color="transparent" shadow={false} className="">
          <CardBody placeholder={undefined} className="col-span-full gap-10 place-items-center overflow-visible grid grid-cols-1 lg:grid-cols-4">
            ...
            <div className="col-span-2 w-full">
              <Typography placeholder={undefined} variant="h6" color="blue" className="mb-4">
                ONLINE COURSE
              </Typography>
              ...
              <Typography placeholder={undefined} className="mb-1 w-full font-normal !text-gray-500">
              ...
              <div className="grid mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <Typography placeholder={undefined} className="w-full font-normal !text-gray-500">
