    ...
    <footer className="px-8 pt-24 pb-8">
      <div className="container max-w-6xl flex flex-col mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 !w-full ">
          ...
          <div className="">
            <Typography placeholder={undefined} variant="h6" className="mb-3 text-left">
              Subscribe
            </Typography>
            <Typography placeholder={undefined} className="!text-gray-500 font-normal mb-4 text-base">
              Get access to subscriber exclusive deals and be the first who gets
              informed about fresh sales.
            </Typography>
            <Typography placeholder={undefined} variant="small" className="font-medium mb-2 text-left">
              Your Email
            </Typography>
            <div className="flex mb-3 flex-col lg:flex-row items-start gap-4">
              <div className="w-full">
                ...
                <Typography placeholder={undefined} className="font-medium mt-3 !text-sm !text-gray-500 text-left">
                  I agree the{" "}
                  <a
                    href="#"
              ...
              <Button placeholder={undefined} color="gray" className="w-full lg:w-fit" size="md">
                button
              </Button>
            </div>
          </div>
